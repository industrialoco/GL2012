package core.collisions
{
	...
	public class GameRect
	{
		 ...
		 */
		public function GameRect(X:Number=0, Y:Number=0, Width:Number=0, Height:Number=0)
		{
			x = X;
			y = Y;
			width = Width;
		 ...
		 */
		public function make(X:Number=0, Y:Number=0, Width:Number=0, Height:Number=0):GameRect
		{
			x = X;
			y = Y;
			width = Width;
		 ...
		 * @return	A reference to itself.
		 */
		public function copyFrom(Rect:GameRect):GameRect
		{
			x = Rect.x;
			y = Rect.y;
			width = Rect.width;
		 ...
		 */
		public function copyTo(Rect:GameRect):GameRect
		{
			Rect.x = x;
			Rect.y = y;
			Rect.width = width;
		 ...
		 * @return	A reference to itself.
		 */
		public function copyFromFlash(FlashRect:Rectangle):GameRect
		{
			x = FlashRect.x;
			y = FlashRect.y;
		 ...
		 */
		public function overlaps(Rect:GameRect):Boolean
		{
